...
create table if not exists map (id bigint not null auto_increment, created datetime(6), created_by varchar(255), modified datetime(6), modified_by varchar(255), map_version varchar(30), to_system varchar(60), to_scope varchar(1024) not null, to_version varchar(60), project_id bigint not null, source_id bigint not null, primary key (id)) engine=InnoDB;
